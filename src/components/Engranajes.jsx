const Engranajes = ({ idioma, eng1, eng2, eng3, eng4, eng5, eng6 }) => (
  <div className='flex justify-evenly pt-6 w-full'>
    ...
    <div className='flex pl-4'>
      <img width='50' src={eng1} alt='foto' />
      <img width='50' src={eng2} alt='foto' />
      <img width='50' src={eng3} alt='foto' />
      <img width='50' src={eng4} alt='foto' />
      <img width='50' src={eng5} alt='foto' />
      <img width='50' src={eng6} alt='foto' />
    </div>
  </div>
);
